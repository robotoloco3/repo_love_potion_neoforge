	...
	public static void registerTrades(VillagerTradesEvent event) {
		if (event.getType() == RepoLovePotionModVillagerProfessions.TAX_MAN.get()) {
			event.getTrades().get(2).add(
					new BasicItemListing(new ItemStack(Items.EMERALD, 16), new ItemStack(Items.BREAD, 32), new ItemStack(RepoLovePotionModItems.I_LOVE_DISK.get()), 10, 0, 0.05f));
			...
			event.getTrades().get(4).add(
					new BasicItemListing(new ItemStack(RepoLovePotionModItems.I_LOVE_DISK.get()), new ItemStack(AllItems.STURDY_SHEET.get(), 10), new ItemStack(RepoLovePotionModItems.VILLAGER_RAP_DISK.get()), 10, 5, 0.05f));
		}
	}
}
