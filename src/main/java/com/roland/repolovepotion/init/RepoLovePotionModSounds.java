...
public class RepoLovePotionModSounds {
	...
	public static final DeferredHolder<SoundEvent, SoundEvent> STARS = REGISTRY.register("stars", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("repo_love_potion", "stars")));
	...
	public static final DeferredHolder<SoundEvent, SoundEvent> D_ME = REGISTRY.register("d_me", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("repo_love_potion", "d_me")));
	...
	public static final DeferredHolder<SoundEvent, SoundEvent> LEMON = REGISTRY.register("lemon", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("repo_love_potion", "lemon")));
	...
	public static final DeferredHolder<SoundEvent, SoundEvent> KISS_ME = REGISTRY.register("kiss_me", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("repo_love_potion", "kiss_me")));
	...
	public static final DeferredHolder<SoundEvent, SoundEvent> RICK_ROLL = REGISTRY.register("rick_roll", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("repo_love_potion", "rick_roll")));
	public static final DeferredHolder<SoundEvent, SoundEvent> RANSOM = REGISTRY.register("ransom", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("repo_love_potion", "ransom")));
	public static final DeferredHolder<SoundEvent, SoundEvent> RUDE = REGISTRY.register("rude", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("repo_love_potion", "rude")));
	public static final DeferredHolder<SoundEvent, SoundEvent> STEREO_HEART = REGISTRY.register("stereo_heart", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("repo_love_potion", "stereo_heart")));
