...
public class RepoLovePotionModItems {
	...
	public static final DeferredItem<Item> INCOMPLETE_UNPOLISHED_HEART_CORE = REGISTRY.register("incomplete_unpublished_heart_core", IncompleteUnpolishedLoveCoreItem::new);
}
